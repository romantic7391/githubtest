...
('지역_수정', '지역 정보 수정', NULL, NULL, NOW(), NOW(), NULL),
...
('학교_수정', '학교 정보 수정', NULL, NULL, NOW(), NOW(), NULL),
('학교_삭제', '학교 삭제', NULL, NULL, NOW(), NOW(), NULL);

-- 센서 관련 권한
INSERT INTO `permission` (`name`, `description`, `default_extra_condition`, `default_extra_limit`, `created`, `updated`, `deleted`) VALUES 
('센서_조회', '센서 상세 조회', NULL, NULL, NOW(), NOW(), NULL),
('센서_목록_조회', '센서 목록 조회', NULL, NULL, NOW(), NOW(), NULL),
('센서_생성', '새로운 센서 생성', NULL, NULL, NOW(), NOW(), NULL),
('센서_수정', '센서 정보 수정', NULL, NULL, NOW(), NOW(), NULL),
...
-- 관리자 그룹 관리 (Manager Group)
INSERT INTO `permission` (`name`, `description`, `default_extra_condition`, `default_extra_limit`, `created`, `updated`, `deleted`) VALUES 
('관리자그룹_조회', '관리자 그룹 목록 조회', NULL, NULL, NOW(), NOW(), NULL),
('관리자그룹_생성', '관리자를 그룹에 할당', NULL, NULL, NOW(), NOW(), NULL),
('관리자그룹_수정', '관리자 그룹 정보 수정', NULL, NULL, NOW(), NOW(), NULL),
('관리자그룹_삭제', '관리자를 그룹에서 제거', NULL, NULL, NOW(), NOW(), NULL);
...
(group_no, `permission_no`, is_allowed)
VALUES 
(311, 245, 'Y'), (321, 245, 'Y'),
(311, 246, 'Y'), (321, 246, 'Y'),
(311, 247, 'Y'), (321, 247, 'Y'),
